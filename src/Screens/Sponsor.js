...
const Sponsor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage(
        "✅ Partner application submitted successfully! We will review your application and get back to you soon.",
      );
      setFormData({
        organization_name: "",
        contact_person: "",
        ...
        <header className={styles.hero}>
          <div className={styles.container}>
            <span className={styles.badge}>
              🤝 Partner with Naija Talent Show 2026
            </span>
            <h1>
              Empower the{" "}
              <span className={styles.goldText}>Future of Talent</span>
            </h1>
            <p>
              Naija Talent Show 2026 is a nationwide movement that uplifts,
              inspires, and connects. Partner with us to make a real impact.
            </p>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.grid}>
              <div className={styles.card}>
                ...
                <p>
                  Showcase your brand to thousands live and millions online.
                </p>
              </div>
              <div className={styles.card}>
              ...
              <div className={styles.card}>
                ...
                <p>
                  Bronze to Platinum tiers designed to fit your brand goals.
                </p>
              </div>
            </div>
          </div>
              ...
              <form className={styles.sponsorForm} onSubmit={handleSubmit}>
                ...
                <div className={styles.inputRow}>
                  ...
                  <input
                    ...
                    placeholder="Company Website / Social Link"
                ...
                <textarea
                  ...
                  placeholder="Brief Message / Partnership Goal"
                  rows="4"
